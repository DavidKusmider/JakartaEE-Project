        ...
        <div id="slide">
            <div class="item" style="background-image: url(./resources/pictures/games/11.png);">
                <div class="content">
                    ...
                    <div class="des">Ark: Survival Evolved is an action-adventure game in which you have to survive on a
                        desert island, but one populated by dinosaurs and other ancient creatures.
                    </div>
            ...
            <div class="item" style="background-image: url(./resources/pictures/games/18.png);">
                <div class="content">
                    ...
                    <div class="des">Team Fortress Classic, one of the most popular online action games of all time,
                        features more than nine character classes.
                    </div>
            ...
            <div class="item" style="background-image: url(./resources/pictures/games/7.png);">
                <div class="content">
                    ...
                    <div class="des">Explore randomly generated worlds and build anything you can think of, from a
                        makeshift shelter to the most fabulous of castles.
                    </div>
            ...
            <div class="item" style="background-image: url(./resources/pictures/games/12.png);">
                <div class="content">
                    ...
                    <div class="des">It can be difficult for a beginner to get through the crucial first stages after
                        the breeding period, as this is the usual PvE you'd expect from a survival game.
                    </div>
            ...
            <div class="item" style="background-image: url(./resources/pictures/games/14.png);">
                <div class="content">
                    ...
                    <div class="des">Terraria is a two-dimensional exploration game in which players seek to shape the
                        world according to their own choices and skills in terms of combat, crafting and resource
                        gathering.
                    </div>
